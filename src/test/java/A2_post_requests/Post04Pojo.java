...
public class Post04Pojo extends RestfulBaseUrl {
    ...
    */
    ...
    public void post04Pojo(){
        ...
        /*
        {"bookingid": 16,
         "booking" :{     ==>   verileri farklı level da olduğu için;
         BookingPojo actualData = response.as(BookingPojo.class); ==> bu obje çalışmadı, sonuçlar null döndü.
         BookingResponseBodyPojo class'ını oluşturarak response body'i bu class'a sığdırdık.(bu şekilde "bookingid": 16
         datası pojo class'ımıza dahil oldu).
         actualData da 2 level olmuş oldu.
         */
