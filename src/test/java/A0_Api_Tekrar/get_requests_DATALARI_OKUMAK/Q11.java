...
public class Q11 extends GoRestBaseUrl {
        /*
    Given
    ...
    And
        "Deeptimoy Jha","Ahilya Sharma" and "Bhuvanesh Saini"  are among the users
    And
    ...
    public void testQ11(){
        ...
        response.then().assertThat().statusCode(200).
                body("meta.pagination.limit",equalTo(10),
                     ...
                     "data.name", hasItems("Deeptimoy Jha","Ahilya Sharma","Bhuvanesh Saini"));
